...
async function main() {
  ...
  master2 = await new Master2__factory(deployer).attach("0xBDd42773555E87141a9E549e1Cf321c7496C12E8")
  // await sleep(5000);
  ...
  master = await new Master__factory(deployer).attach("0x5e82D707EF9A86e0e8682b34Aa4421254bFA2cF4");
...
console.log('await master.userBuyCounters(deployer.address,1) :>> ', await master.userBuyCounters(deployer.address,1));
  // let tx = await master
  //   .connect(deployer)
  //   .deployProject(
  //     [
