...
interface SupplyLimitTestInterface extends ethers.utils.Interface {
  functions: {
...
export class SupplyLimitTest extends Contract {
  ...
  filters: {
    ...
    SupplyLimitSet(
      _limit: null
    ): TypedEventFilter<[BigNumber], { _limit: BigNumber }>;
