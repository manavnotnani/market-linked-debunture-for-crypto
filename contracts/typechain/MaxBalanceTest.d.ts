...
interface MaxBalanceTestInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "IDBalance", values: [string]): string;
...
export class MaxBalanceTest extends Contract {
  ...
  functions: {
    IDBalance(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    MaxBalanceSet(
      _maxBalance: null
    ): TypedEventFilter<[BigNumber], { _maxBalance: BigNumber }>;
